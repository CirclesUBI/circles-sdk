...
V1_HUB_INFLATION="${V1_HUB_INFLATION:-107}"
V1_HUB_PERIOD="${V1_HUB_PERIOD:-31556952}"
V1_HUB_SYMBOL="${V1_HUB_SYMBOL:-CRC}"
V1_HUB_NAME="${V1_HUB_NAME:-Circles}"
V1_HUB_SIGNUP_BONUS="${V1_HUB_SIGNUP_BONUS:-50000000000000000000}"
V1_HUB_INITIAL_ISSUANCE="${V1_HUB_INITIAL_ISSUANCE:-92592592592592}"
V1_HUB_TIMEOUT="${V1_HUB_TIMEOUT:-7776000}"
...
V2_DEMURRAGE_ZERO_DAY="${V2_DEMURRAGE_ZERO_DAY:-1602786330}"
V2_HUB_STANDARD_TREASURY="${V2_HUB_STANDARD_TREASURY:-0x1234567890123456789012345678901234567890}"
V2_HUB_BOOTSTRAP_TIME="${V2_HUB_BOOTSTRAP_TIME:-15552000}" # 180 days
V2_HUB_FALLBACK_URL="${V2_HUB_FALLBACK_URL:-https://example.com}"
...
export $V1_HUB_ADDRESS
export $V2_HUB_ADDRESS
